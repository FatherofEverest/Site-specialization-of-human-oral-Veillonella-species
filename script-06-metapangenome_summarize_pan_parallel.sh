...
declare -a siteArray=("BM" "TD" "SUPP" "PT" "TH" "KG" "SUBP" "SV" "HP")
...
do
	...
	/workspace/jmarkwelchlab/P_1221_Veillonella/SCRIPTS/script-metapangenome.sh ${projectID} ${site} &
	fi
done
...
declare -a siteArray=("BM" "TD" "SUPP" "PT" "TH" "KG" "SUBP" "SV" "HP" "PERIO")
...
do
	...
	then
	((i=i%num_processes)); ((i++==0)) && wait
	/workspace/jmarkwelchlab/P_1221_Veillonella/SCRIPTS/script-summary_metapan.sh ${projectID} ${site} &
	fi
done
